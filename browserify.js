/**
 * NOTE: This overrides the default browserify functionality so that the uglify config can be passed.
 * This should be fixed on Elixir 6, so once it's released this file can be removed.
 */
...
Elixir.extend('browserifyuglify', function(src, output, baseDir, options) {
    ...
    new Elixir.Task('browserify', function() {
        ...
        bundle = function(stream, paths) {
            ...
            return (
                ...
                .pipe(new Elixir.Notification('Browserify Uglify Compiled!'))
            );
        }.bind(this);
